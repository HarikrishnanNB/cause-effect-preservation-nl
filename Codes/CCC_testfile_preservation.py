...
plt.plot(COUP_COEFF1, M_causes_S, '-*k', markersize = 10, label = "M causes S Firing Time")
plt.plot(COUP_COEFF1, S_causes_M, '-or', markersize = 10, label = "S causes M Firing Time")
...
np.save(RESULT_PATH_FINAL +'NL_CCC_firing_time_M_causes_S.npy', M_causes_S)
np.save(RESULT_PATH_FINAL +'NL_CCC_firing_time_S_causes_M.npy', S_causes_M)